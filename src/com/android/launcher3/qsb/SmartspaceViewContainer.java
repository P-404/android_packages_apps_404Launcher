...
import com.android.launcher3.P404Launcher;
import com.android.launcher3.P404LauncherModelDelegate;
...
public class SmartspaceViewContainer extends FrameLayout implements PluginListener<BcSmartspaceDataPlugin> {
    ...
    public SmartspaceViewContainer(Context context, AttributeSet attributeSet) {
        ...
        P404Launcher launcher = (P404Launcher) ActivityContext.lookupContext(context);
        launcher.getLauncherUnlockAnimationController().setSmartspaceView(mView);

        P404LauncherModelDelegate delegate = (P404LauncherModelDelegate) launcher.getModel().getModelDelegate();
    ...
    public void onPluginDisconnected(BcSmartspaceDataPlugin plugin) {
        P404Launcher launcher = (P404Launcher) ActivityContext.lookupContext(getContext());
