...
import com.p404.launcher.qsb.QsbAnimationController;
...
public class P404LauncherCallbacks implements LauncherCallbacks,
        SharedPreferences.OnSharedPreferenceChangeListener, OnChangeListener {
    public static final String SEARCH_PACKAGE = "com.google.android.googlequicksearchbox";

    private final P404Launcher mLauncher;
    ...
    public P404LauncherCallbacks(P404Launcher launcher) {
        mLauncher = launcher;
    }
    ...
    private ClientOptions getClientOptions(SharedPreferences prefs) {
        boolean hasPackage = P404Utils.hasPackageInstalled(mLauncher, SEARCH_PACKAGE);
