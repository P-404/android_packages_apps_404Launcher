...
public class LongClickReceiver extends BroadcastReceiver {
    ...
    public static WeakReference<P404Launcher> mWeakReference = new WeakReference(null);

    public static void getWeakReference(P404Launcher launcher) {
        mWeakReference = new WeakReference(launcher);
    }

    @Override
    public void onReceive(Context context, Intent intent) {
        P404Launcher launcher = (P404Launcher) mWeakReference.get();
        if (launcher != null) {
