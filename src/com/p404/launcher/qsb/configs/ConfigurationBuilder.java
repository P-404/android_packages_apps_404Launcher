 ...
 */
package com.p404.launcher.qsb.configs;
...
import com.p404.launcher.P404Launcher;
import com.p404.launcher.P404LauncherCallbacks;
import com.p404.launcher.qsb.AllAppsQsbContainer;
import com.p404.launcher.search.nano.SearchProto.Columns;
import com.p404.launcher.search.nano.SearchProto.AppIndex;
import com.p404.launcher.search.nano.SearchProto.SearchBase;
import com.p404.launcher.search.nano.SearchProto.SearchView;
import com.p404.launcher.search.AppSearchProvider;
...
public class ConfigurationBuilder {
    ...
    public static Intent getSearchIntent(Rect sourceBounds, View gIcon, View micIcon) {
        ...
        return intent.putExtra("source_round_left", true)
                ...
                .setPackage(P404LauncherCallbacks.SEARCH_PACKAGE).addFlags(Intent.FLAG_ACTIVITY_NO_HISTORY | Intent.FLAG_ACTIVITY_NEW_TASK);
    }
